    ...
    <div>
      ...
      <div className="min-h-[calc(100vh-4rem)] bg-secondary flex items-center w-full">
        <form
          ...
          className="w-full max-w-xl mx-auto rounded-2xl border bg-background p-6 sm:p-8 my-10 shadow-sm"
        >
          <h1 className="font-bold text-xl mb-5 text-center text-primary">
            Login
          </h1>
          <div className="my-2">
            <Label>Email</Label>
